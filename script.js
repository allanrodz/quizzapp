let questions = [
    {
        "question": "How many All-Ireland Senior Hurling Titles did Kilkenny win between 1960 and 2023?",
        "answers": [
    ...
    {
        "question": "How many All-Star Awards have Kilkenny players won since their inception in  1971?",
        "answers": [
    ...
    {
        "question": "In how many different positions did J.J. Delaney start All-Ireland Finals?",
        "answers": [
    ...
    },
    {
        ...
        "answers": [
            ...
            {"text": "Claus Dunne", "correct": false},
            {"text": "Tom Walsh", "correct": false},
            {"text": "Sean Clohessy", "correct": false}
        ]
    },
    {
        "question": "Which player scored 1-3 and won the Man of the Match award in the 2006 All-Ireland Final?",
        "answers": [
    ...
    {
        "question": "How many goals did Pat Delaney score in his 27 games for Kilkenny?",
        "answers": [
            {"text": "30", "correct": false},
    ...
    { 
        "question": "How many All-Ireland senior medals did Eddie Brennan win?",
        "answers": [
    ...
    {
        "question": "In what year did Eddie Keher score his highest ever total (2-11) in an All-Ireland final and still end up on the losing side?",
        "answers": [
    ...
    {
        "question": "Which of these players won three All-Ireland medals starting in the centre forward position?",
        "answers": [
            {"text": "Henry Shefflin", "correct": false},
            {"text": "D.J. Carey", "correct": false},
    ...
    {
        "question": "Which of these players was NOT selected at both full back and full forward in All-Ireland finals?",
        "answers": [
            {"text": "J.J. Delaney", "correct": true},
    ...
    {
        "question": "Only one of these Kilkenny goalkeepers won the All-Ireland Poc Fada Championship. Which one?",
        "answers": [
            {"text": "Noel Skehan", "correct": false},
            {"text": "Ollie Walsh", "correct": true},
            {"text": "Eoin Murphy", "correct": false},
    ...
    },
    {
        ...
        "answers": [
            ...
            {"text": "Ollie Walsh", "correct": true},
            {"text": "Seamus Cleere", "correct": false}
        ]
    },{
                "question": "Who captained Kilkenny to two All-Ireland victories in 1983 and 1992 and was the only player to be presented with the old and new Liam McCarthy Cups?",
        "answers": [
   ...
   {
        "question": "Who won Hurler of the Year in 1983 and was known for his powerful physique?",
        "answers": [
            {"text": "Frank Cummins", "correct": true},
            {"text": "Eddie Keher", "correct": false},
            {"text": "Pat Henderson", "correct": false},
    ...
    {
        "question": "Who scored 1-3 in a Man of the Match performance in the 2006 All-Ireland Hurling Final?",
        "answers": [
    ...
    },
    {
        ...
        "answers": [
            ...
            {"text": "Liam O’Brien", "correct": false},
            {"text": "Billy Fitzpatrick", "correct": false},
            {"text": "Matt Ruth", "correct": false}
        ]
    },
    {
        "question": "Which of these Kilkenny men has NOT won the All-Ireland Poc Fada Championship?",
        "answers": [
            {"text": "Ollie Walsh", "correct": false},
            {"text": "Oliver Gough", "correct": false},
            {"text": "Noel Skehan", "correct": true},
            {"text": "Killian Phelan", "correct": false}
        ]
    },
    {
        "question": "Who is the Kilkenny player with eight All-Ireland medals, a Hurler of the Year award but just two All-Stars?",
        "answers": [
            {"text": "Eoin Larkin", "correct": true},
            {"text": "Henry Shefflin", "correct": false},
            {"text": "T.J. Reid", "correct": false},
    ...
    {
        "question": "Who captained Kilkenny to the four-in-a-row in 2009?",
        "answers": [
    ...
    {
        "question": "Who was the player with a natural ciotóg and considered the physically strongest hurler by many?",
        "answers": [
            {"text": "Frank Cummins", "correct": true},
            {"text": "Richie Hogan", "correct": false},
            {"text": "Henry Shefflin", "correct": false},
    ...
    {
        "question": "How many All-Ireland Senior Hurling Finals have Kilkenny won by a single point?",
        "answers": [
            {"text": "3", "correct": false},
            {"text": "4", "correct": false},
            {"text": "5", "correct": false},
    ...
    {
        "question": "Which is the only county to have played in four consecutive All-Ireland Senior Hurling Finals but winning just one of them?",
        "answers": [
            {"text": "Cork", "correct": false},
            {"text": "Kilkenny", "correct": false},
            {"text": "London", "correct": true},
            {"text": "Tipperary", "correct": false}
        ]
    },
    {
        "question": "Which of these counties was the last to win its first All-Ireland Senior Hurling title?",
        "answers": [
            {"text": "Dublin", "correct": false},
            {"text": "Kerry", "correct": false},
            {"text": "Kilkenny", "correct": true},
            {"text": "London", "correct": false}
        ]
    },
    {
        "question": "Which of these counties has won the most All-Ireland Senior Hurling titles?",
        "answers": [
    ...
    {
        "question": "Which is the only county to have reached the All-Ireland Senior Hurling Final but never won it?",
        "answers": [
            {"text": "Antrim", "correct": true},
            {"text": "Kerry", "correct": false},
            {"text": "Laois", "correct": false},
            {"text": "Westmeath", "correct": false}
        ]
    },
    {
        "question": "Who was the first Kilkenny goalkeeper to win an All Star Award?",
        "answers": [
            {"text": "Kevin Fennelly", "correct": false},
            {"text": "James McGarry", "correct": false},
            {"text": "Noel Skehan", "correct": true},
            {"text": "Michael Walsh", "correct": false}
        ]
    }
]
